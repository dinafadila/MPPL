            ...
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('gender') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('') ? ' is-invalid' : '' }}" name="gender" id="input-gender" type="text" placeholder="{{ __('Jenis Kelamin') }}" value="{{ old('name', auth()->user()->gender) }}" required="true" aria-required="true"/>
                      @if ($errors->has('gender'))
                        <span id="name-error" class="error text-danger" for="input-gender">{{ $errors->first('gender') }}</span>
                      @endif
                    </div>
                  </div> 
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('place_of_birth') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('') ? ' is-invalid' : '' }}" name="place_of_birth" id="input-place_of_birth" type="text" placeholder="{{ __('Tempat Lahir') }}" value="{{ old('name', auth()->user()->place_of_birth) }}" required="true" aria-required="true"/>
                      @if ($errors->has('place_of_birth'))
                        <span id="name-error" class="error text-danger" for="input-place_of_birth">{{ $errors->first('name') }}</span>
                      @endif
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="input-name" type="text" placeholder="{{ __('Tanggal Lahir') }}" value="{{ old('name', auth()->user()->date_of_birth) }}" required="true" aria-required="true"/>
                      @if ($errors->has('name'))
                        <span id="name-error" class="error text-danger" for="input-name">{{ $errors->first('name') }}</span>
                      @endif
                    </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="input-name" type="text" placeholder="{{ __('Agama') }}" value="{{ old('name', auth()->user()->region) }}" required="true" aria-required="true"/>
                      @if ($errors->has('name'))
                        <span id="name-error" class="error text-danger" for="input-name">{{ $errors->first('name') }}</span>
                      @endif
                    </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" id="input-email" type="email" placeholder="{{ __('Tanggal Masuk') }}" value="{{ old('email', auth()->user()->date_of_entry) }}" required />
                      @if ($errors->has('email'))
                        <span id="email-error" class="error text-danger" for="input-email">{{ $errors->first('email') }}</span>
                      @endif
                    </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="input-name" type="text" placeholder="{{ __('Alamat') }}" value="{{ old('name', auth()->user()->address) }}" required="true" aria-required="true"/>
                      @if ($errors->has('name'))
                        <span id="name-error" class="error text-danger" for="input-name">{{ $errors->first('name') }}</span>
                      @endif
                    </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="input-name" type="text" placeholder="{{ __('No. HP') }}" value="{{ old('name', auth()->user()->contact) }}" required="true" aria-required="true"/>
                      @if ($errors->has('name'))
                        <span id="name-error" class="error text-danger" for="input-name">{{ $errors->first('name') }}</span>
                      @endif
                    </div>
