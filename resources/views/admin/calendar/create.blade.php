                                ...
                                <form role="form" action="{{ route('calendar.store') }}" method="POST">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" name="name_of_event" id="name_of_event" placeholder="Nama Kegiatan">
                                        </div>
                                        <div class="col-12">
                                            <label>Deskripsi Kegiatan</label>
                                            <input type="text" class="form-control" name="information" id="information" placeholder="Deskripsi Kegiatan">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-6">
                                            <label>Tanggal dimulai</label>
                                            <input type="date" class="form-control" name="date_of_start" id="start_date" placeholder="Tanggal dimulai">
                                        </div>
                                        <div class="col-6">
                                            <label>Tanggal berakhir</label>
                                            <input type="date" class="form-control" name="date_of_end" id="end_date" placeholder="Tanggal berakhir">
                                        </div>
                                    </div>
