...
<title>Admin | Edit SPP Siswa/i</title>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Edit SPP Siswa/i</h1>
                </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Beranda</a></li>
                    <li class="breadcrumb-item active">Edit SPP Siswa/i</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="biodata">
                                ...
                                @endif
                                <form role="form" action="{{ route('fee.update', $fee->id) }}" method="POST">
                                    <!-- row 0 -->
                                    @csrf
                                    @method('PUT')
